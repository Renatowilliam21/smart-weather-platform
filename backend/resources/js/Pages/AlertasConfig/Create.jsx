...
export default function Create({ estacoes, parametros }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('alertas-config.store'));
    };
    ...
    return (
        ...
        >
            <Head title="Nova Configuração de Alerta" />
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                <PrimaryButton disabled={processing}>Criar Configuração</PrimaryButton>
