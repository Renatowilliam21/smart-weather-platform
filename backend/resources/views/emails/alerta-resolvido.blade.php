...
<head>
    ...
    <style>
        ...
        .header { background-color: #14532d; color: #fff; padding: 20px 24px; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>🟢 Alerta resolvido automaticamente</h1>
        </div>
        <div class="body">
            <p>O parâmetro monitorado voltou a ficar dentro do limite configurado.</p>
            ...
            <table class="info-table">
                ...
                <tr>
                    <td>Parâmetro</td>
                    <td>{{ $alertaDisparado->alertaConfig->parametro ?? 'N/A' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Resolvido em</td>
                    <td>{{ $alertaDisparado->resolvido_em?->format('d/m/Y H:i:s') ?? now()->format('d/m/Y H:i:s') }}</td>
                </tr>
            </table>
